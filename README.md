A selection test for Database Management System Assistant Recruitment which I became the person in charge for the entire selection series. The case are all in Indonesian (Bahasa).
